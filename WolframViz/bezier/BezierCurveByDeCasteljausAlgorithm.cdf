...
NotebookDataLength[     84956,       1736]
NotebookOptionsPosition[     57872,       1155]
NotebookOutlinePosition[     84148,       1716]
CellTagsIndexPosition[     84037,       1710]
WindowTitle->B\351zier Curve by de Casteljau's Algorithm
WindowFrame->Normal*)
...
Cell["\<\
B\[EAcute]zier Curve by de Casteljau's Algorithm\
\>", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`r$$ = 3, $CellContext`s$$ = 0.5, 
    Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`r$$], 3, "r"}, {1, 2, 3}}, {{
       Hold[$CellContext`s$$], 0.5, "t"}, 0.01, 1}}, Typeset`size$$ = {
    500., {185., 190.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`r$2122$$ = 
    0, $CellContext`s$2123$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`r$$ = 3, $CellContext`s$$ = 0.5}, 
      "ControllerVariables" :> {
        Hold[$CellContext`r$$, $CellContext`r$2122$$, 0], 
        Hold[$CellContext`s$$, $CellContext`s$2123$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`plt$}, $CellContext`plt$ = Part[
           ParametricPlot[
            $CellContext`b[$CellContext`t, 0, 3], {$CellContext`t, 
             0, $CellContext`s$$}, PlotStyle -> {Blue, 
              Thickness[0.01]}], 1]; Which[$CellContext`r$$ == 1, 
          Graphics[{{
             Lighter[Gray], 
             Line[{
               $CellContext`p[0], 
             ...
             Point[{
               ...
               $CellContext`p[1], 
               $CellContext`p[2], 
               $CellContext`p[3]}]}, {Purple, 
             PointSize[0.015], 
             Point[{
               $CellContext`b[$CellContext`s$$, 0, 1], 
               $CellContext`b[$CellContext`s$$, 1, 1], 
               $CellContext`b[$CellContext`s$$, 2, 1]}]}, {Purple, 
             Thickness[0.005], 
             Line[{
               $CellContext`p[0], 
               $CellContext`b[$CellContext`s$$, 0, 1]}], 
             ...
             Line[{
               $CellContext`p[2], 
               $CellContext`b[$CellContext`s$$, 2, 1]}]}}, 
           PlotRange -> {{-0.1, 4.1}, {-0.1, 2.6}}, 
           ImageSize -> {500, 375}], $CellContext`r$$ == 2, 
          Graphics[{{
             Lighter[Gray], 
             Line[{
               $CellContext`p[0], 
             ...
             Point[{
               ...
               $CellContext`b[$CellContext`s$$, 1, 1], 
               $CellContext`b[$CellContext`s$$, 2, 1], 
               $CellContext`b[$CellContext`s$$, 0, 2], 
               $CellContext`b[$CellContext`s$$, 1, 2]}]}, {Purple, 
             Thickness[0.005], 
             Line[{{
                $CellContext`p[0], 
                $CellContext`b[$CellContext`s$$, 0, 1]}, {
                ...
                $CellContext`b[$CellContext`s$$, 0, 2]}, {
                $CellContext`b[$CellContext`s$$, 1, 1], 
                $CellContext`b[$CellContext`s$$, 1, 2]}}]}}, 
           PlotRange -> {{-0.1, 4.1}, {-0.1, 2.6}}, 
           ImageSize -> {500, 375}], $CellContext`r$$ == 3, 
          Graphics[{$CellContext`plt$, {
             Lighter[Gray], 
             Line[{
               $CellContext`p[0], 
               $CellContext`p[1], 
             ...
             Point[{
               ...
               $CellContext`b[$CellContext`s$$, 0, 2], 
               $CellContext`b[$CellContext`s$$, 1, 2], 
               $CellContext`b[$CellContext`s$$, 0, 3]}]}, {Purple, 
             Thickness[0.005], 
             Line[{{
                $CellContext`p[0], 
                $CellContext`b[$CellContext`s$$, 0, 1]}, {
                ...
                $CellContext`b[$CellContext`s$$, 1, 2]}, {
                $CellContext`b[$CellContext`s$$, 0, 2], 
                $CellContext`b[$CellContext`s$$, 0, 3]}}]}}, 
           PlotRange -> {{-0.1, 4.1}, {-0.1, 2.6}}, 
           ImageSize -> {500, 375}]]], 
      "Specifications" :> {{{$CellContext`r$$, 3, "r"}, {1, 2, 
         3}}, {{$CellContext`s$$, 0.5, "t"}, 0.01, 1}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{545., {241., 246.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`plt = Dynamic[
          Part[
           ParametricPlot[
            $CellContext`b[$CellContext`t, 0, 3], {$CellContext`t, 0, 
             FE`s$$21}, PlotStyle -> {Blue, 
              Thickness[0.01]}], 1]], $CellContext`b[
          Pattern[$CellContext`t, 
           Blank[]], 0, 1] = {
         0. (1 - $CellContext`t) + 0.5 $CellContext`t, 
          0.5 (1 - $CellContext`t) + 2.5 $CellContext`t}, $CellContext`b[
          Pattern[$CellContext`t, 
           Blank[]], 1, 1] = {
         0.5 (1 - $CellContext`t) + 3. $CellContext`t, 
          2.5 (1 - $CellContext`t) + 2. $CellContext`t}, $CellContext`b[
          Pattern[$CellContext`t, 
           Blank[]], 2, 1] = {
         3. (1 - $CellContext`t) + 4. $CellContext`t, 2. (1 - $CellContext`t) + 
          0. $CellContext`t}, $CellContext`b[
          Pattern[$CellContext`t, 
           Blank[]], 
          ...
          Pattern[$CellContext`r, 
           Blank[]]] := (
           1 - $CellContext`t) $CellContext`b[$CellContext`t, $CellContext`i, \
$CellContext`r - 
            1] + $CellContext`t $CellContext`b[$CellContext`t, $CellContext`i + 
            1, $CellContext`r - 1], FE`s$$21 = 
        0.3, $CellContext`p[0] = {0., 0.5}, $CellContext`p[1] = {0.5, 
         2.5}, $CellContext`p[2] = {3., 2.}, $CellContext`p[3] = {4., 0.}}; 
      Typeset`initDone$$ = True); ReleaseHold[
       HoldComplete[{$CellContext`b[
            ...
            Pattern[$CellContext`r, 
             Blank[]]] := (
             1 - $CellContext`t) $CellContext`b[$CellContext`t, \
$CellContext`i, $CellContext`r - 
              1] + $CellContext`t $CellContext`b[$CellContext`t, \
$CellContext`i + 1, $CellContext`r - 1]; Null, {
          HoldComplete[$CellContext`b[
              Pattern[$CellContext`t, 
               Blank[]], 0, 
              1] = (1 - $CellContext`t) $CellContext`p[
               0] + $CellContext`t $CellContext`p[1]; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`b[
              Pattern[$CellContext`t, 
               Blank[]], 1, 
              1] = (1 - $CellContext`t) $CellContext`p[
               1] + $CellContext`t $CellContext`p[2]; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`b[
              Pattern[$CellContext`t, 
               Blank[]], 2, 
              1] = (1 - $CellContext`t) $CellContext`p[
               2] + $CellContext`t $CellContext`p[3]; Null], 
          HoldComplete[Null]}, {
          HoldComplete[$CellContext`p[0] = {0., 0.5}; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`p[1] = {0.5, 2.5}; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`p[2] = {3., 2.}; Null], 
          HoldComplete[Null], 
          HoldComplete[$CellContext`p[3] = {4., 0.}; Null], 
          HoldComplete[Null]}}]]; Typeset`initDone$$ = True),
...
Cell[TextData[{
 ...
 " changes from 1 to 3 a sequence of linear interpolations shows how to \
construct a point on the cubic B\[EAcute]zier curve when there are four \
control points. The parameter ",
 Cell[BoxData[
...
Cell[TextData[{
 ...
 ", the B\[EAcute]zier curve can be constructed by the recurrence relation ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{
     SubsuperscriptBox["B", "i", "r"], "(", "t", ")"}], "=", 
    RowBox[{
     RowBox[{
      RowBox[{"(", 
       RowBox[{"1", "-", "t"}], ")"}], " ", 
     ...
     RowBox[{"t", " ", 
      RowBox[{
       SubsuperscriptBox["B", 
        RowBox[{"i", "+", "1"}], 
        RowBox[{"r", "-", "1"}]], "(", "t", ")"}]}]}]}], TraditionalForm]], 
  "InlineMath"],
 " where ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubsuperscriptBox["B", "i", "1"], "=", 
    RowBox[{
     RowBox[{
      RowBox[{"(", 
       RowBox[{"1", "-", "t"}], ")"}], " ", 
...
BezierCurveByDeCasteljausAlgorithm&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/BezierCurveByDeCasteljausAlgorithm/\
BezierCurveByDeCasteljausAlgorithm-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["B\[EAcute]zier Curve by de Casteljau's Algorithm",
  BaseStyle->"SiteLink",
  ButtonData->{
...
BezierCurveByDeCasteljausAlgorithm/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BezierCurveByDeCasteljausAlgorithm/\
"], None},
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"B\[EAcute]zier Curve by de Casteljau's Algorithm",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[45579, 836, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[45840, 845, 2503, 55, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[57050, 1130, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 83750, 1699},
 {"Copyright", 83945, 1704}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[607, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34938, 590, 77, 2, 70, "DemoTitle"],
Cell[35018, 594, 9977, 224, 70, "Output",
 CellID->267183928],
Cell[44998, 820, 578, 14, 70, "ManipulateCaption",
 CellID->1295000531],
Cell[45579, 836, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45840, 845, 2503, 55, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[48346, 902, 33, 0, 70, "DetailsSection"],
Cell[48382, 904, 1927, 68, 70, "DetailNotes",
 CellID->343659102],
Cell[50312, 974, 44, 0, 70, "RelatedLinksSection"],
Cell[50359, 976, 571, 20, 70, "RelatedLinks",
 CellID->327162172],
Cell[50933, 998, 4841, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[55777, 1089, 45, 0, 70, "CitationSection"],
Cell[55825, 1091, 895, 25, 70, "Citations"],
Cell[56723, 1118, 324, 10, 70, "Author"],
Cell[57050, 1130, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature hSEW@dAB2jbtjvQNMdxKbu8Z *)
