...
NotebookDataLength[     91949,       2015]
NotebookOptionsPosition[     65149,       1429]
NotebookOutlinePosition[     91436,       1990]
CellTagsIndexPosition[     91325,       1984]
WindowTitle->Generating a Bezier Curve by the de Casteljau Algorithm
WindowFrame->Normal*)
...
Cell["Generating a Bezier Curve by the de Casteljau Algorithm", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`i$$ = 4, $CellContext`SamplePoints$$ = {{0, 
    0}, {2, 4}, {4, 5}, {6, 4}, {7, 1}, {9, 2}, {10, 1}}, $CellContext`u$$ = 
    0.45, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`i$$], 4, "order of the Bezier curve"}, 1, 
      Dynamic[Length[$CellContext`SamplePoints$$] - 1], 1}, {{
       Hold[$CellContext`u$$], 0.45, 
       Row[{"the index ", 
         Style["u", Italic], ", 0 \[LessEqual] ", 
         Style["u", Italic], " \[LessEqual] 1"}]}, 0, 1}, {{
       Hold[$CellContext`SamplePoints$$], {{0, 0}, {2, 4}, {4, 5}, {6, 4}, {7,
        1}, {9, 2}, {10, 1}}}, {-1, -1}, {11, 6}}}, Typeset`size$$ = {
    750., {247., 253.}}, Typeset`update$$ = 0, Typeset`initDone$$, 
    Typeset`skipInitDone$$ = False, $CellContext`i$52712$$ = 
    0, $CellContext`u$52713$$ = 0, $CellContext`SamplePoints$52714$$ = {0, 
    0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`i$$ = 
        4, $CellContext`SamplePoints$$ = {{0, 0}, {2, 4}, {4, 5}, {6, 4}, {7, 
         1}, {9, 2}, {10, 1}}, $CellContext`u$$ = 0.45}, 
      "ControllerVariables" :> {
        Hold[$CellContext`i$$, $CellContext`i$52712$$, 0], 
        Hold[$CellContext`u$$, $CellContext`u$52713$$, 0], 
        Hold[$CellContext`SamplePoints$$, $CellContext`SamplePoints$52714$$, {
         0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> $CellContext`deCasteljauBezier[
        Part[$CellContext`SamplePoints$$, 
         Span[1, $CellContext`i$$ + 1]], $CellContext`u$$, 
        PlotRange -> {{-1, 11}, {-1, 6}}, ImageSize -> {600, 400}], 
      "Specifications" :> {{{$CellContext`i$$, 4, 
          "order of the Bezier curve"}, 1, 
         Dynamic[Length[$CellContext`SamplePoints$$] - 1], 1, Appearance -> 
         "Labeled"}, {{$CellContext`u$$, 0.45, 
          Row[{"the index ", 
            Style["u", Italic], ", 0 \[LessEqual] ", 
            Style["u", Italic], " \[LessEqual] 1"}]}, 0, 1, Appearance -> 
         "Labeled"}, {{$CellContext`SamplePoints$$, {{0, 0}, {2, 4}, {4, 5}, {
          6, 4}, {7, 1}, {9, 2}, {10, 1}}}, {-1, -1}, {11, 6}, ControlType -> 
         Locator, Appearance -> None}}, "Options" :> {}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{803., {309., 314.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(($CellContext`deCasteljau[
       ...
       NestList[
        MovingAverage[#, {
          1 - $CellContext`u0, $CellContext`u0}]& , $CellContext`pts, 
         Length[$CellContext`pts] - 1]; $CellContext`deCasteljauBezier[
         Pattern[$CellContext`pts$, {
           Repeated[{
             Blank[], 
             Blank[]}]}], 
         ...
         Pattern[$CellContext`opts$, 
          OptionsPattern[Plot]]] := 
       Module[{$CellContext`ptsCoordi$, $CellContext`n$, \
$CellContext`aimCoordi$, $CellContext`ptsName$}, $CellContext`n$ = 
          Length[$CellContext`pts$] - 
           1; $CellContext`ptsCoordi$ = \
$CellContext`deCasteljau[$CellContext`pts$, $CellContext`u$]; \
$CellContext`aimCoordi$ = 
          Last[$CellContext`ptsCoordi$]; $CellContext`ptsName$ = Flatten[
            Table[
             Subscript[
              Style[
              "P", Italic], $CellContext`k, $CellContext`i$$], \
{$CellContext`k, 1, $CellContext`n$}, {$CellContext`i$$, 
              0, $CellContext`n$ - $CellContext`k}]]; Graphics[
           Join[{
             PointSize[0.006], Blue}, 
            Map[Point, 
             Most[$CellContext`ptsCoordi$]], {
             PointSize[0.008], Red, 
             Point[$CellContext`aimCoordi$]}, {Black}, 
            Map[Line, $CellContext`ptsCoordi$], {Pink, 
             
             BezierCurve[$CellContext`pts$, 
              SplineDegree -> $CellContext`n$]}], Epilog -> {
             Apply[Text, 
              Join[
               Thread[{
                 Table[
                  Style[
                   Subscript[
                    Style["P", Italic], $CellContext`i$$], 12, 
                   Orange], {$CellContext`i$$, 0, $CellContext`n$}], 
                 Map[# + {0.2, 0.2}& , $CellContext`pts$]}], 
               Thread[{
                 MapAt[Style[#, 10, Magenta]& , 
                  MapAt[
                  Style[#, 11, 
                    Red]& , $CellContext`ptsName$, $CellContext`n$ \
(($CellContext`n$ + 1)/2)], 
                  Map[List, 
                   Range[1, $CellContext`n$ (($CellContext`n$ + 1)/2) - 1]]], 
                 Map[# + {0.2, 0.2}& , 
                  Flatten[
                   Rest[$CellContext`ptsCoordi$], 1]]}]], {1}], 
             Text[
              Style[
               StringForm["see point ``", 
                Subscript[
                 Style["P", Italic], $CellContext`n$]], 15, Green], 
              Scaled[{0.4, 0.2}]]}, $CellContext`opts$]]; Null); 
...
Cell[TextData[{
 "This Demonstration shows how to generate a Bezier curve by the de Casteljau \
algorithm. An ",
 Cell[BoxData[
  FormBox[
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"0", "\[LessEqual]", "u", "\[LessEqual]", "1"}], TraditionalForm]],
   "InlineMath"],
 "."
}], "ManipulateCaption",
 CellID->51650089],
...
Cell[TextData[{
 ...
 " to indicate a point at that percentage of the segment's length. Use these \
points to make ",
 Cell[BoxData[
  FormBox[
   RowBox[{"n", "-", "1"}], TraditionalForm]], "InlineMath"],
 " segments, and repeat using the same index. More formally, define a basis \
function:"
}], "ManipulateCaption",
 CellID->123583679],
   ...
   RowBox[{
    ...
    SuperscriptBox[
     RowBox[{
      SuperscriptBox["u", "i"], "(", 
      RowBox[{"1", "-", "u"}], ")"}], 
     RowBox[{"n", "-", "i"}]]}]}], TraditionalForm], "\[IndentingNewLine]", 
 FormBox[
  RowBox[{"                ", 
   RowBox[{"=", 
    RowBox[{
  ...
  FormBox[
   RowBox[{
    RowBox[{
     SubscriptBox["C", "n"], "(", 
     RowBox[{
      SubscriptBox["P", "0"], ",", "\[CenterEllipsis]", ",", 
      SubscriptBox["P", "n"]}], ")"}], "=", 
    RowBox[{
     RowBox[{
      RowBox[{"(", 
...
Cell[TextData[{
 ...
 Cell[BoxData[
  FormBox[
   SubscriptBox["P", 
    RowBox[{"0", ",", "i"}]], TraditionalForm]], "InlineMath"],
...
Cell["This is called the de Casteljau algorithm.", "ManipulateCaption",
 CellID->2238243],
...
Cell[TextData[{
 ...
 StyleBox["The NURBS Book,",
  FontSlant->"Italic"],
 " 2nd ed., Berlin: Springer-Verlag, 1997 pp. 9\[Dash]10, 23\[Dash]24."
}], "DetailNotes",
 CellID->560817407],
...
GeneratingABezierCurveByTheDeCasteljauAlgorithm&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
GeneratingABezierCurveByTheDeCasteljauAlgorithm/\
GeneratingABezierCurveByTheDeCasteljauAlgorithm-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Generating a Bezier Curve by the de Casteljau Algorithm",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
GeneratingABezierCurveByTheDeCasteljauAlgorithm/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
GeneratingABezierCurveByTheDeCasteljauAlgorithm/"],
 "\"",
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[52918, 1141, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[53179, 1150, 4472, 99, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[64327, 1404, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 91036, 1973},
 {"Copyright", 91233, 1978}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[1532, 34, 34328, 567, 70, "DemonstrationHeader"],
Cell[35863, 603, 76, 0, 70, "DemoTitle"],
Cell[35942, 605, 5879, 129, 70, "Output",
 CellID->652650252],
Cell[41824, 736, 285, 8, 70, "ManipulateCaption",
 CellID->554337377],
Cell[42112, 746, 1059, 40, 70, "ManipulateCaption",
 CellID->51650089],
Cell[43174, 788, 532, 15, 70, "ManipulateCaption",
 CellID->123583679],
Cell[43709, 805, 5746, 203, 70, "ManipulateCaption",
 CellID->145900684],
Cell[49458, 1010, 469, 16, 70, "ManipulateCaption",
 CellID->731315633],
Cell[49930, 1028, 834, 28, 70, "ManipulateCaption",
 CellID->740031757],
Cell[50767, 1058, 120, 3, 70, "ManipulateCaption",
 CellID->1261518],
Cell[50890, 1063, 862, 31, 70, "ManipulateCaption",
 CellID->227705061],
Cell[51755, 1096, 1068, 40, 70, "ManipulateCaption",
 CellID->700732674],
Cell[52826, 1138, 89, 1, 70, "ManipulateCaption",
 CellID->2238243],
Cell[52918, 1141, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[53179, 1150, 4472, 99, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[57654, 1251, 33, 0, 70, "DetailsSection"],
Cell[57690, 1253, 53, 1, 70, "DetailNotes",
 CellID->1519185691],
Cell[57746, 1256, 212, 6, 70, "DetailNotes",
 CellID->560817407],
Cell[57961, 1264, 4884, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[62848, 1357, 45, 0, 70, "CitationSection"],
Cell[62896, 1359, 342, 11, 70, "Author",
 CellID->8872619],
Cell[63241, 1372, 1083, 30, 70, "Citations"],
Cell[64327, 1404, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature 7QU2wV2ZvEfD8uAtyzJmY6GL *)
