...
NotebookDataLength[     89155,       1926]
NotebookOptionsPosition[     61365,       1324]
NotebookOutlinePosition[     87641,       1885]
CellTagsIndexPosition[     87530,       1879]
WindowTitle->Subdivision Algorithm for B\351zier Curves
WindowFrame->Normal*)
...
Cell["\<\
Subdivision Algorithm for B\[EAcute]zier Curves\
\>", "DemoTitle"],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`f$$ = True, $CellContext`k$$ = 
    1, $CellContext`pt$$ = {{-2.8, -1}, {0, 1}, {2.8, -1}}, $CellContext`t$$ =
     0.5, Typeset`show$$ = True, Typeset`bookmarkList$$ = {}, 
    Typeset`bookmarkMode$$ = "Menu", Typeset`animator$$, Typeset`animvar$$ = 
    1, Typeset`name$$ = "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`k$$], 1}, 0, 5, 1}, {{
       Hold[$CellContext`t$$], 0.5, "\!\(\*SubscriptBox[\(t\), \(0\)]\)"}, 0, 
      1}, {{
       Hold[$CellContext`pt$$], {{-2.8, -1}, {0, 1}, {2.8, -1}}}, {-3, -2}, {
      3, 2}}, {{
       Hold[$CellContext`f$$], True, "curve"}, {True, False}}}, 
    Typeset`size$$ = {500., {148., 152.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = False, $CellContext`k$921$$ =
     0, $CellContext`t$922$$ = 0, $CellContext`pt$923$$ = {0, 
    0}, $CellContext`f$924$$ = False}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`f$$ = True, $CellContext`k$$ = 
        1, $CellContext`pt$$ = {{-2.8, -1}, {0, 1}, {
          2.8, -1}}, $CellContext`t$$ = 0.5}, "ControllerVariables" :> {
        Hold[$CellContext`k$$, $CellContext`k$921$$, 0], 
        Hold[$CellContext`t$$, $CellContext`t$922$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$923$$, {0, 0}], 
        Hold[$CellContext`f$$, $CellContext`f$924$$, False]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        ...
        Graphics[{
          Line[$CellContext`pt$$], Red, 
          Line[
           $CellContext`subdivision[$CellContext`pt$$, $CellContext`t$$, \
$CellContext`k$$]]}, PlotRange -> {{-3, 3}, {-2, 2}}, AspectRatio -> 
         Automatic], 
        ParametricPlot[
         $CellContext`m[$CellContext`pt$$, $CellContext`t$$], \
{$CellContext`t$$, 0, 1}, PlotStyle -> If[$CellContext`f$$, 
           ColorData[1][1], None]], PlotRange -> {{-3, 3}, {-2, 2}}, 
        AspectRatio -> Automatic, ImageSize -> {500, 300}], 
      "Specifications" :> {{{$CellContext`k$$, 1}, 0, 5, 1, Appearance -> 
         "Labeled"}, {{$CellContext`t$$, 0.5, 
          "\!\(\*SubscriptBox[\(t\), \(0\)]\)"}, 0, 1, Appearance -> 
         "Labeled"}, {{$CellContext`pt$$, {{-2.8, -1}, {0, 1}, {
           2.8, -1}}}, {-3, -2}, {3, 2}, ControlType -> Locator, 
         LocatorAutoCreate -> {1, 
           DirectedInfinity[1]}}, {{$CellContext`f$$, True, "curve"}, {
         True, False}}}, "Options" :> {ControllerLinking -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{551., {217., 222.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(($CellContext`m[
         Pattern[$CellContext`p, 
          Blank[]], 
         Pattern[$CellContext`t, 
          Blank[]]] := Module[{$CellContext`n = Length[$CellContext`p] - 1}, 
         Sum[
         BernsteinBasis[$CellContext`n, $CellContext`i - 1, $CellContext`t] 
          Part[$CellContext`p, $CellContext`i], {$CellContext`i, 
           1, $CellContext`n + 1}]]; $CellContext`decast[
         Pattern[$CellContext`pts, 
          Blank[]], 
         Pattern[$CellContext`t, 
          Blank[]]] := 
       Module[{$CellContext`n = 
          Length[$CellContext`pts] - 1, $CellContext`a}, $CellContext`a = 
          Table[0, {$CellContext`n + 1}]; 
         Part[$CellContext`a, 1] = $CellContext`pts; 
         For[$CellContext`j = 1, $CellContext`j <= $CellContext`n, 
           Increment[$CellContext`j], 
           Part[$CellContext`a, $CellContext`j + 1] = 
           Table[(1 - $CellContext`t) 
              Part[$CellContext`a, $CellContext`j, $CellContext`i + 
                1] + $CellContext`t 
              Part[$CellContext`a, $CellContext`j, $CellContext`i + 
                2], {$CellContext`i, 0, $CellContext`n - $CellContext`j}]]; {
           Table[
            
            Part[$CellContext`a, $CellContext`j, 1], {$CellContext`j, 
             1, $CellContext`n + 1}], 
           Table[
            
            Part[$CellContext`a, $CellContext`n + 
             2 - $CellContext`j, $CellContext`j], {$CellContext`j, 
             1, $CellContext`n + 1}]}]; $CellContext`subdivision[
         Pattern[$CellContext`pts, 
          Blank[]], 
         Pattern[$CellContext`t, 
          Blank[]], 0] := $CellContext`pts; $CellContext`subdivision[
         Pattern[$CellContext`pts, 
          Blank[]], 
         Pattern[$CellContext`t, 
          Blank[]], 
         Pattern[$CellContext`k, 
          Blank[]]] := Flatten[
         Table[
          $CellContext`subdivision[
           Part[
            $CellContext`decast[$CellContext`pts, $CellContext`t], \
$CellContext`i], $CellContext`t, $CellContext`k - 1], {$CellContext`i, 2}], 
...
Cell["\<\
This Demonstration illustrates the convergence of the de Casteljau-based \
subdivision algorithm for B\[EAcute]zier curves.\
\>", "ManipulateCaption"],
...
Cell[TextData[{
 "The subdivision algorithm follows from the de Casteljau algorithm that \
calculates a current point ",
 Cell[BoxData[
  FormBox[
   RowBox[{"C", "(", 
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["t", "0"], "\[Element]", 
    RowBox[{"[", 
     RowBox[{"0", ",", "1"}], "]"}]}], TraditionalForm]], "InlineMath"],
 ", of a polynomial B\[EAcute]zier curve ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    RowBox[{"C", "(", "t", ")"}], "=", 
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{" ", 
    RowBox[{
     RowBox[{"i", " ", "=", " ", "0"}], " ", ",", "\[Ellipsis]", ",", 
     RowBox[{"n", "-", "j"}]}]}], TraditionalForm]], "InlineMath"],
 "."
}], "DetailNotes",
 CellID->28959647],
      ...
      RowBox[{
       SubscriptBox["B", 
        RowBox[{"i", ",", 
         RowBox[{"n", "-", "j"}]}]], "(", 
       SubscriptBox["t", "0"], ")"}], " ", 
      SubsuperscriptBox["P", "i", "j"]}]}]}], TraditionalForm]], "InlineMath"],
 "."
}], "DetailNotes",
 CellID->61327558],

Cell[TextData[{
 "The subdivision algorithm associates to the polygon ",
 Cell[BoxData[
  FormBox[
   RowBox[{"P", "=", 
    RowBox[{"(", 
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"P", "=", 
    RowBox[{"(", 
     RowBox[{
      SubsuperscriptBox["P", "0", "0"], ",", 
      SubsuperscriptBox["P", "0", "1"], ",", 
      SubsuperscriptBox["P", "0", "2"], ",", "\[Ellipsis]", ",", 
      SubsuperscriptBox["P", "0", "n"]}], ")"}]}], TraditionalForm]], 
  "InlineMath"],
 " and ",
 Cell[BoxData[
  FormBox[
   RowBox[{"P", "=", 
    RowBox[{"(", 
     RowBox[{
      SubsuperscriptBox["P", "0", "n"], ",", 
      SubsuperscriptBox["P", "1", 
       RowBox[{"n", "-", "1"}]], ",", 
      SubsuperscriptBox["P", "2", 
       RowBox[{"n", "-", "2"}]], ",", "\[Ellipsis]", ",", 
      SubsuperscriptBox["P", "n", "0"]}], ")"}]}], TraditionalForm]], 
  "InlineMath"],
 ...
 Cell[BoxData[
  FormBox[
   RowBox[{"[", 
    RowBox[{
     SubscriptBox["t", "0"], ",", "1"}], "]"}], TraditionalForm]], 
  "InlineMath"],
 ":"
}], "DetailNotes",
 CellID->351509641],
    ...
    RowBox[{
     ...
     RowBox[{
      RowBox[{
       SubscriptBox["B", 
        RowBox[{"i", ",", "n"}]], "(", "t", ")"}], " ", 
      SubsuperscriptBox["P", "0", "i"]}]}]}],
   FontSize->13], TraditionalForm]], "InlineMath"]], "DetailNotes",
 CellID->253114401],
    ...
    StyleBox[
     RowBox[{
      ...
      RowBox[{
       ...
       SubsuperscriptBox["P", "i", 
        RowBox[{"n", "-", "i"}]]}]}],
     FontSize->13]}], TraditionalForm]], "InlineMath"],
 "."
}], "DetailNotes",
 CellID->691591443],
  ...
  FormBox[
   RowBox[{
    ...
    RowBox[{
     RowBox[{"(", 
      RowBox[{"1", "-", 
       SubscriptBox["t", "0"]}], ")"}], "t"}]}], TraditionalForm]], 
  "InlineMath"],
 " varies over ",
 Cell[BoxData[
  FormBox[
...
Cell[TextData[{
 "This Demonstration illustrates repeated application of the above procedure \
(the control \"k\" denotes the number of iterations). Obviously, the \
resulting polygon sequence converges very quickly to the curve ",
 Cell[BoxData[
  FormBox[
   RowBox[{"C", "(", "t", ")"}], TraditionalForm]], "InlineMath"],
 "."
...
Cell[TextData[{
 ButtonBox["B\[EAcute]zier Curves",
  BaseStyle->"Hyperlink",
  ButtonData->{
...
Cell[TextData[{
 ButtonBox["de Casteljau algorithm",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BezierCurveByDeCasteljausAlgorithm/\
"], None},
  ButtonNote->
...
SubdivisionAlgorithmForBezierCurves&version=0009"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/SubdivisionAlgorithmForBezierCurves/\
SubdivisionAlgorithmForBezierCurves-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Subdivision Algorithm for B\[EAcute]zier Curves",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
SubdivisionAlgorithmForBezierCurves/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/SubdivisionAlgorithmForBezierCurves/"],
 "\"",
 " from ",
...
SubdivisionAlgorithmForBezierCurves/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
SubdivisionAlgorithmForBezierCurves/"], None},
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"Subdivision Algorithm for B\[EAcute]zier Curves",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[40514, 713, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[40775, 722, 4819, 107, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[60543, 1299, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 87242, 1868},
 {"Copyright", 87438, 1873}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[606, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34937, 590, 76, 2, 70, "DemoTitle"],
Cell[35016, 594, 5332, 112, 70, "Output",
 CellID->87865799],
Cell[40351, 708, 160, 3, 70, "ManipulateCaption"],
Cell[40514, 713, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[40775, 722, 4819, 107, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[45597, 831, 33, 0, 70, "DetailsSection"],
Cell[45633, 833, 1206, 40, 70, "DetailNotes",
 CellID->652576205],
Cell[46842, 875, 376, 14, 70, "DetailNotes",
 CellID->74493484],
Cell[47221, 891, 722, 26, 70, "DetailNotes",
 CellID->28959647],
Cell[47946, 919, 304, 12, 70, "DetailNotes",
 CellID->89356120],
Cell[48253, 933, 523, 19, 70, "DetailNotes",
 CellID->61327558],
Cell[48779, 954, 1698, 58, 70, "DetailNotes",
 CellID->351509641],
Cell[50480, 1014, 502, 16, 70, "DetailNotes",
 CellID->253114401],
Cell[50985, 1032, 46, 1, 70, "DetailNotes",
 CellID->262587963],
Cell[51034, 1035, 866, 36, 70, "DetailNotes",
 CellID->691591443],
Cell[51903, 1073, 893, 37, 70, "DetailNotes",
 CellID->698901599],
Cell[52799, 1112, 367, 9, 70, "DetailNotes",
 CellID->32487853],
Cell[53169, 1123, 44, 0, 70, "RelatedLinksSection"],
Cell[53216, 1125, 635, 21, 70, "RelatedLinks",
 CellID->410279509],
Cell[53854, 1148, 521, 16, 70, "RelatedLinks",
 CellID->88341511],
Cell[54378, 1166, 4844, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[59225, 1257, 45, 0, 70, "CitationSection"],
Cell[59273, 1259, 899, 25, 70, "Citations"],
Cell[60175, 1286, 365, 11, 70, "Author"],
Cell[60543, 1299, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature gRqsSDwzoQUi9umcfFfxjCDk *)
