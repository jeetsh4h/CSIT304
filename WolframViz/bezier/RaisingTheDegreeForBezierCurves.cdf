...
NotebookDataLength[     92059,       2042]
NotebookOptionsPosition[     63922,       1429]
NotebookOutlinePosition[     90194,       1990]
CellTagsIndexPosition[     90083,       1984]
WindowTitle->Raising the Degree for B\351zier Curves
WindowFrame->Normal*)
...
Cell["\<\
Raising the Degree for B\[EAcute]zier Curves\
\>", "DemoTitle"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`k$$ = 
    1, $CellContext`pt$$ = {{-2.8, -1}, {0, 1}, {2.8, -1}}, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`k$$], 1, "number of iterations k"}, 1, 15, 1}, {{
       Hold[$CellContext`pt$$], {{-2.8, -1}, {0, 1}, {2.8, -1}}}, {-3, -2}, {
      3, 2}}}, Typeset`size$$ = {500., {148., 152.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = False, $CellContext`k$792$$ =
     0, $CellContext`pt$793$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`k$$ = 
        1, $CellContext`pt$$ = {{-2.8, -1}, {0, 1}, {2.8, -1}}}, 
      "ControllerVariables" :> {
        Hold[$CellContext`k$$, $CellContext`k$792$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$793$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`n$}, $CellContext`n$ = 
         Length[$CellContext`pt$$] - 1; Show[
          Graphics[{
            RGBColor[0.6, 0.73, 0.36], 
            Line[$CellContext`pt$$], 
            RGBColor[0.49, 0, 0], 
            Line[
             $CellContext`elevation[$CellContext`pt$$, $CellContext`k$$]]}], 
          ParametricPlot[
           $CellContext`m[$CellContext`pt$$, $CellContext`n$, \
$CellContext`t], {$CellContext`t, 0, 1}, PlotStyle -> Thick], 
          PlotRange -> {{-3, 3}, {-2, 2}}, AspectRatio -> Automatic, 
          ImageSize -> {500, 300}]], 
      "Specifications" :> {{{$CellContext`k$$, 1, "number of iterations k"}, 
         1, 15, 1, Appearance -> 
         "Labeled"}, {{$CellContext`pt$$, {{-2.8, -1}, {0, 1}, {
           2.8, -1}}}, {-3, -2}, {3, 2}, ControlType -> Locator, 
         LocatorAutoCreate -> {1, 
           DirectedInfinity[1]}}}, "Options" :> {ControllerLinking -> False}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{551., {195., 200.}},
     SingleEvaluation->True],
    Deinitialization:>None,
    DynamicModuleValues:>{},
    Initialization:>(({$CellContext`elevation[
          Pattern[$CellContext`p, 
           Blank[]], 0] := $CellContext`p, $CellContext`elevation[
          Pattern[$CellContext`p, 
           Blank[]], 1] := Module[{$CellContext`n = Length[$CellContext`p]}, 
          Join[{
            Part[$CellContext`p, 1]}, 
           
           Table[($CellContext`i/$CellContext`n) 
             Part[$CellContext`p, $CellContext`i] + (($CellContext`n - \
$CellContext`i)/$CellContext`n) 
             Part[$CellContext`p, $CellContext`i + 1], {$CellContext`i, 
             1, $CellContext`n - 1}], {
            Last[$CellContext`p]}]], $CellContext`elevation[
          Pattern[$CellContext`p, 
           Blank[]], 
          Pattern[$CellContext`k, 
           Blank[]]] := $CellContext`elevation[
          $CellContext`elevation[$CellContext`p, $CellContext`k - 1], 
          1], $CellContext`m[
          Pattern[$CellContext`p, 
           Blank[]], 
          ...
          Pattern[$CellContext`t, 
           Blank[]]] := 
        Sum[$CellContext`b[$CellContext`i - 1, $CellContext`n, $CellContext`t]
            Part[$CellContext`p, $CellContext`i], {$CellContext`i, 
           1, $CellContext`n + 1}], $CellContext`b[
          ...
          Pattern[$CellContext`t, 
           Blank[]]] := 
        Binomial[$CellContext`n, $CellContext`i] (
           1 - $CellContext`t)^($CellContext`n - $CellContext`i) \
$CellContext`t^$CellContext`i, Attributes[Thick] = {ReadProtected}, 
        Attributes[PlotRange] = {ReadProtected}}; Typeset`initDone$$ = True); 
     ReleaseHold[{{
         HoldComplete[$CellContext`b[
            Pattern[$CellContext`i, 
             Blank[]], 
            Pattern[$CellContext`n, 
             Blank[]], 
...
$CellContext`t^$CellContext`i], 
         ...
         HoldComplete[$CellContext`m[
            ...
            Pattern[$CellContext`t, 
             Blank[]]] := 
          Sum[$CellContext`b[$CellContext`i - 
              1, $CellContext`n, $CellContext`t] 
            Part[$CellContext`p, $CellContext`i], {$CellContext`i, 
             1, $CellContext`n + 1}]], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`elevation[
             Pattern[$CellContext`p, 
              Blank[]], 0] := $CellContext`p; Null], 
         HoldComplete[Null], 
         HoldComplete[$CellContext`elevation[
             Pattern[$CellContext`p, 
              Blank[]], 1] := 
...
$CellContext`i)/$CellContext`n) 
         ...
         HoldComplete[$CellContext`elevation[
             ...
             Pattern[$CellContext`k, 
              Blank[]]] := $CellContext`elevation[
             $CellContext`elevation[$CellContext`p, $CellContext`k - 1], 1]; 
...
Cell[TextData[{
 "A B\[EAcute]zier curve in the plane is given by parametric equations of the \
form ",
 Cell[BoxData[
  FormBox[
   RowBox[{
 ...
 " are points in the plane called control points and ",
 Cell[BoxData[
  FormBox[
   RowBox[{
    SubscriptBox["B", 
 ...
 ". This parametrization can be changed (without changing the curve) via a \
recursive procedure outlined in the Details section that generates a new set \
of control points larger by 1 at each iteration. The figure shows the B\
\[EAcute]zier curve, the original control polygon (obtained by connecting the \
control points with line segments), and the control polygon determined by the \
control points after some iterations of the recursive procedure. This \
artificial process is useful in CAGD to increase the flexibility for the \
designer. It may also be used in numerous contexts where several \
B\[EAcute]zier curves need to be represented with the same degree, for \
example to join two curves by a B\[EAcute]zier surface, or to compare two \
curves, etc."
}], "ManipulateCaption",
 CellID->106552894],
...
Cell["A B\[EAcute]zier curve is defined by", "DetailNotes",
 CellID->488398134],
  ...
  FormBox[
   RowBox[{
    SubscriptBox["B", 
     RowBox[{"i", ",", "n"}]], "(", "t", ")"}], TraditionalForm]], 
  "InlineMath"],
 " are the Bernstein polynomials. Applying the following recursive formula \
for the control points raises the degree of the Bernstein basis:"
}], "DetailNotes",
 CellID->36054762],
     ...
     RowBox[{
      RowBox[{
       SubscriptBox["B", 
        RowBox[{"i", ",", "n"}]], "(", "t", ")"}], " ", 
      SubscriptBox["P", "i"]}]}],
    TraditionalForm], " "}], TraditionalForm]], "InlineMath"]], "DetailNotes",
 CellID->139921946],
...
Cell["\<\
Although the curve has a new control polygon, its parametrization remains the \
same. For further details, see:\
\>", "DetailNotes",
 CellID->464324435],

Cell[TextData[{
 "G. Farin, ",
 StyleBox["Curves and Surfaces for Computer Aided Geometric Design",
  FontSlant->"Italic"],
...
Cell[TextData[{
 ButtonBox["B\[EAcute]zier Curve",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://mathworld.wolfram.com/BezierCurve.html"], None},
  ButtonNote->"http://mathworld.wolfram.com/BezierCurve.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
RaisingTheDegreeForBezierCurves&version=0011"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/RaisingTheDegreeForBezierCurves/\
RaisingTheDegreeForBezierCurves-source.nb"]], "DemoSourceNotebookSection",
 CellFrame->{{0, 0}, {1, 1}},
...
Cell[TextData[{
 "\"",
 ButtonBox["Raising the Degree for B\[EAcute]zier Curves",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/RaisingTheDegreeForBezierCurves/"],
     None},
  ButtonNote->
   "http://demonstrations.wolfram.com/RaisingTheDegreeForBezierCurves/"],
 "\"",
 ...
 ButtonBox["http://demonstrations.wolfram.com/RaisingTheDegreeForBezierCurves/\
",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/RaisingTheDegreeForBezierCurves/"],
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Isabelle Cattiaux-Huillard",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Isabelle+\
Cattiaux-Huillard"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Isabelle+Cattiaux-\
Huillard"],
 " and ",
 ButtonBox["Gudrun Albrecht",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Gudrun+\
Albrecht"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Gudrun+Albrecht"]
}], "Author",
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"Raising the Degree for B\[EAcute]zier Curves",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43599, 799, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43860, 808, 3600, 80, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[63100, 1404, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 89796, 1973},
 {"Copyright", 89991, 1978}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[603, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34934, 590, 73, 2, 70, "DemoTitle"],
Cell[35010, 594, 6390, 143, 70, "Output",
 CellID->1290514],
Cell[41403, 739, 2193, 58, 70, "ManipulateCaption",
 CellID->106552894],
Cell[43599, 799, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43860, 808, 3600, 80, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[47463, 890, 33, 0, 70, "DetailsSection"],
Cell[47499, 892, 79, 1, 70, "DetailNotes",
 CellID->488398134],
Cell[47581, 895, 405, 15, 70, "DetailNotes",
 CellID->173964755],
Cell[47989, 912, 357, 11, 70, "DetailNotes",
 CellID->36054762],
Cell[48349, 925, 195, 8, 70, "DetailNotes",
 CellID->124158727],
Cell[48547, 935, 630, 26, 70, "DetailNotes",
 CellID->662357175],
Cell[49180, 963, 220, 9, 70, "DetailNotes",
 CellID->54084404],
Cell[49403, 974, 210, 8, 70, "DetailNotes",
 CellID->370894018],
Cell[49616, 984, 462, 17, 70, "DetailNotes",
 CellID->124115126],
Cell[50081, 1003, 50, 1, 70, "DetailNotes",
 CellID->223151531],
Cell[50134, 1006, 430, 14, 70, "DetailNotes",
 CellID->139921946],
Cell[50567, 1022, 769, 30, 70, "DetailNotes",
 CellID->438953344],
Cell[51339, 1054, 1337, 54, 70, "DetailNotes",
 CellID->381168781],
Cell[52679, 1110, 1188, 44, 70, "DetailNotes",
 CellID->286843370],
Cell[53870, 1156, 1303, 46, 70, "DetailNotes",
 CellID->209168115],
Cell[55176, 1204, 473, 18, 70, "DetailNotes",
 CellID->327196481],
Cell[55652, 1224, 162, 4, 70, "DetailNotes",
 CellID->464324435],
Cell[55817, 1230, 197, 6, 70, "DetailNotes",
 CellID->136041985],
Cell[56017, 1238, 44, 0, 70, "RelatedLinksSection"],
Cell[56064, 1240, 634, 21, 70, "RelatedLinks",
 CellID->410279509],
Cell[56701, 1263, 4832, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[61536, 1354, 45, 0, 70, "CitationSection"],
Cell[61584, 1356, 882, 25, 70, "Citations"],
Cell[62469, 1383, 628, 19, 70, "Author"],
Cell[63100, 1404, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature sQqhS0isLaHAOv7EuS0JbKdA *)
