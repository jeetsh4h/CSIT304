...
NotebookDataLength[     77356,       1546]
NotebookOptionsPosition[     50071,        957]
NotebookOutlinePosition[     76326,       1518]
CellTagsIndexPosition[     76215,       1512]
WindowTitle->B\351zier Curve Flowers
WindowFrame->Normal*)
...
Cell["B\[EAcute]zier Curve Flowers", "DemoTitle",
 CellID->700863240],

Cell[BoxData[
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`bColor$$ = True, $CellContext`fOff$$ = 
    0.5, $CellContext`iDeg$$ = 9, $CellContext`iDiv$$ = 
    23, $CellContext`iLoops$$ = 1, $CellContext`iMul$$ = 7, Typeset`show$$ = 
    True, Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`bColor$$], True, "color"}, {True, False}}, {{
       Hold[$CellContext`iDiv$$], 23, "divisions"}, 2, 40, 1}, {{
       Hold[$CellContext`iDeg$$], 9, "degree of curve"}, 1, 11, 1}, {{
       Hold[$CellContext`iMul$$], 7, "skip"}, 1, 10, 1}, {{
       Hold[$CellContext`fOff$$], 0.5, "move points"}, 0, 1.5, 0.01}, {{
       Hold[$CellContext`iLoops$$], 1, "add points"}, 1, 4, 1}}, 
    Typeset`size$$ = {375., {185., 190.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    True, $CellContext`bColor$6877$$ = False, $CellContext`iDiv$6878$$ = 
    0, $CellContext`iDeg$6879$$ = 0, $CellContext`iMul$6880$$ = 
    0, $CellContext`fOff$6881$$ = 0, $CellContext`iLoops$6882$$ = 0}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`bColor$$ = True, $CellContext`fOff$$ = 
        0.5, $CellContext`iDeg$$ = 9, $CellContext`iDiv$$ = 
        23, $CellContext`iLoops$$ = 1, $CellContext`iMul$$ = 7}, 
      "ControllerVariables" :> {
        Hold[$CellContext`bColor$$, $CellContext`bColor$6877$$, False], 
        Hold[$CellContext`iDiv$$, $CellContext`iDiv$6878$$, 0], 
        Hold[$CellContext`iDeg$$, $CellContext`iDeg$6879$$, 0], 
        Hold[$CellContext`iMul$$, $CellContext`iMul$6880$$, 0], 
        Hold[$CellContext`fOff$$, $CellContext`fOff$6881$$, 0], 
        Hold[$CellContext`iLoops$$, $CellContext`iLoops$6882$$, 0]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      DynamicModule[{$CellContext`ptlists, $CellContext`img, \
$CellContext`pts2}, $CellContext`pts2 = Table[If[
             EvenQ[$CellContext`i], 1., $CellContext`fOff$$] {
             
             Sin[((2 Pi) $CellContext`i) \
($CellContext`iMul$$/$CellContext`iDiv$$)], 
             
             Cos[((2 Pi) $CellContext`i) \
($CellContext`iMul$$/$CellContext`iDiv$$)]}, {$CellContext`i, 
            0, ($CellContext`iLoops$$/2) 
            LCM[$CellContext`iDiv$$, $CellContext`iDeg$$, \
$CellContext`iMul$$]}]; $CellContext`ptlists = 
         Partition[$CellContext`pts2, $CellContext`iDeg$$ + 
           1, $CellContext`iDeg$$]; $CellContext`img = Graphics[{
            Table[{
              If[$CellContext`bColor$$, 
               Hue[2 ($CellContext`k/Length[$CellContext`ptlists])], Black], 
              BezierCurve[
               Part[$CellContext`ptlists, $CellContext`k], 
               SplineDegree -> $CellContext`iDeg$$]}, {$CellContext`k, 
              Length[$CellContext`ptlists]}]}, ImageSize -> {375, 375}]], 
      "Specifications" :> {{{$CellContext`bColor$$, True, "color"}, {
         True, False}}, {{$CellContext`iDiv$$, 23, "divisions"}, 2, 40, 1, 
         ImageSize -> Tiny, Appearance -> 
         "Labeled"}, {{$CellContext`iDeg$$, 9, "degree of curve"}, 1, 11, 1, 
         ImageSize -> Tiny, Appearance -> 
         "Labeled"}, {{$CellContext`iMul$$, 7, "skip"}, 1, 10, 1, ImageSize -> 
         Tiny, Appearance -> 
         "Labeled"}, {{$CellContext`fOff$$, 0.5, "move points"}, 0, 1.5, 0.01,
          ImageSize -> Tiny, Appearance -> 
         "Labeled"}, {{$CellContext`iLoops$$, 1, "add points"}, 1, 4, 1, 
         ImageSize -> Tiny, Appearance -> "Labeled"}}, 
      "Options" :> {ControlPlacement -> Left}, 
      "DefaultOptions" :> {ControllerLinking -> True}],
     ImageSizeCache->{622., {214., 219.}},
...
Cell["\<\
This Demonstration joins together many B\[EAcute]zier curves into symmetrical \
flower-like shapes.\
\>", "ManipulateCaption",
 CellID->1044312921],
...
Cell[TextData[{
 "Based on neat example #2 from the Wolfram Research documentation on ",
 StyleBox["BezierCurve", "MR"],
 "."
}], "DetailNotes",
 CellID->245322920],
...
Cell[TextData[{
 ButtonBox["BezierCurve",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://reference.wolfram.com/mathematica/ref/BezierCurve.html"], 
    None},
  ButtonNote->"http://reference.wolfram.com/mathematica/ref/BezierCurve.html"],
 " (",
 ButtonBox["Wolfram",
  BaseStyle->"SiteLink",
  ButtonData->{
...
BezierCurveFlowers&version=0006"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/BezierCurveFlowers/BezierCurveFlowers-\
...
Cell[TextData[{
 "\"",
 ButtonBox["B\[EAcute]zier Curve Flowers",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BezierCurveFlowers/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/BezierCurveFlowers/"],
 "\"",
 " from ",
 ...
 ButtonBox["http://demonstrations.wolfram.com/BezierCurveFlowers/",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/BezierCurveFlowers/"], None},
  ButtonNote->"http://demonstrations.wolfram.com/BezierCurveFlowers/"]
...
Cell[TextData[{
 "Contributed by: ",
 ButtonBox["Hein Hundal",
  BaseStyle->"Hyperlink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/author.html?author=Hein+Hundal"], 
    None},
  ButtonNote->
   "http://demonstrations.wolfram.com/author.html?author=Hein+Hundal"]
}], "Author",
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"B\[EAcute]zier Curve Flowers",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[39507, 682, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[39768, 691, 1372, 31, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[49249, 932, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 75929, 1501},
 {"Copyright", 76124, 1506}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[587, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34918, 590, 69, 1, 70, "DemoTitle",
 CellID->700863240],
Cell[34990, 593, 4354, 81, 70, "Output",
 CellID->140311749],
Cell[39347, 676, 157, 4, 70, "ManipulateCaption",
 CellID->1044312921],
Cell[39507, 682, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[39768, 691, 1372, 31, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[41143, 724, 33, 0, 70, "DetailsSection"],
Cell[41179, 726, 164, 5, 70, "DetailNotes",
 CellID->245322920],
Cell[41346, 733, 42, 1, 70, "DetailNotes",
 CellID->29624037],
Cell[41391, 736, 44, 0, 70, "RelatedLinksSection"],
Cell[41438, 738, 843, 28, 70, "RelatedLinks",
 CellID->221727717],
Cell[42284, 768, 634, 21, 70, "RelatedLinks",
 CellID->112539971],
Cell[42921, 791, 4793, 89, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[47717, 882, 45, 0, 70, "CitationSection"],
Cell[47765, 884, 781, 20, 70, "Citations"],
Cell[48549, 906, 340, 11, 70, "Author",
 CellID->95413255],
Cell[48892, 919, 354, 11, 70, "Author",
 CellID->101170927],
Cell[49249, 932, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
...
(* NotebookSignature SRUkkDeohqhaYvQNIIa#WE7U *)
