...
NotebookDataLength[     81922,       1638]
NotebookOptionsPosition[     54856,       1058]
NotebookOutlinePosition[     81140,       1619]
CellTagsIndexPosition[     81029,       1613]
WindowTitle->Variation Diminishing Property for B\351zier Curves
WindowFrame->Normal*)
...
Cell["\<\
Variation Diminishing Property for B\[EAcute]zier Curves\
\>", "DemoTitle"],
 ...
 TagBox[
  StyleBox[
   DynamicModuleBox[{$CellContext`h$$ = 
    0, $CellContext`pt$$ = {{-2.8, -1}, {0, 1}, {
     2.8, -1}}, $CellContext`\[Alpha]$$ = 0.5, Typeset`show$$ = True, 
    Typeset`bookmarkList$$ = {}, Typeset`bookmarkMode$$ = "Menu", 
    Typeset`animator$$, Typeset`animvar$$ = 1, Typeset`name$$ = 
    "\"untitled\"", Typeset`specs$$ = {{{
       Hold[$CellContext`h$$], 0}, -2, 2}, {{
       Hold[$CellContext`\[Alpha]$$], 0.5}, Rational[-1, 2] Pi, 
      Rational[1, 2] Pi}, {{
       Hold[$CellContext`pt$$], {{-2.8, -1}, {0, 1}, {2.8, -1}}}, {-3, -2}, {
      3, 2}}}, Typeset`size$$ = {500., {148., 152.}}, Typeset`update$$ = 0, 
    Typeset`initDone$$, Typeset`skipInitDone$$ = 
    False, $CellContext`h$15057$$ = 0, $CellContext`\[Alpha]$15058$$ = 
    0, $CellContext`pt$15059$$ = {0, 0}}, 
    DynamicBox[Manipulate`ManipulateBoxes[
     1, StandardForm, 
      "Variables" :> {$CellContext`h$$ = 
        0, $CellContext`pt$$ = {{-2.8, -1}, {0, 1}, {
          2.8, -1}}, $CellContext`\[Alpha]$$ = 0.5}, "ControllerVariables" :> {
        Hold[$CellContext`h$$, $CellContext`h$15057$$, 0], 
        Hold[$CellContext`\[Alpha]$$, $CellContext`\[Alpha]$15058$$, 0], 
        Hold[$CellContext`pt$$, $CellContext`pt$15059$$, {0, 0}]}, 
      "OtherVariables" :> {
       Typeset`show$$, Typeset`bookmarkList$$, Typeset`bookmarkMode$$, 
        Typeset`animator$$, Typeset`animvar$$, Typeset`name$$, 
        Typeset`specs$$, Typeset`size$$, Typeset`update$$, Typeset`initDone$$,
         Typeset`skipInitDone$$}, "Body" :> 
      Module[{$CellContext`n$, $CellContext`l$, $CellContext`soluce1$, \
$CellContext`soluce2$}, $CellContext`n$ = 
         Length[$CellContext`pt$$] - 1; $CellContext`soluce1$ = Cases[
           
           NSolve[{$CellContext`u 
              Cos[$CellContext`\[Alpha]$$], $CellContext`h$$ + $CellContext`u 
               Sin[$CellContext`\[Alpha]$$]} == \
$CellContext`m[$CellContext`pt$$, $CellContext`n$, $CellContext`t]], \
{$CellContext`u -> Blank[], $CellContext`t -> Condition[
               Pattern[$CellContext`c, 
                Blank[]], 
               $CellContext`test[$CellContext`c]]} -> {$CellContext`t -> \
$CellContext`c}]; $CellContext`l$ = 
         Table[{(1 - $CellContext`t) 
             Part[$CellContext`pt$$, $CellContext`i] + $CellContext`t 
             Part[$CellContext`pt$$, $CellContext`i + 1], 
            
            NSolve[{$CellContext`u 
               Cos[$CellContext`\[Alpha]$$], $CellContext`h$$ + \
$CellContext`u Sin[$CellContext`\[Alpha]$$]} == (1 - $CellContext`t) 
               Part[$CellContext`pt$$, $CellContext`i] + $CellContext`t 
               Part[$CellContext`pt$$, $CellContext`i + 1]]}, {$CellContext`i,
             1, $CellContext`n$}]; $CellContext`soluce2$ = ReleaseHold[
           Cases[$CellContext`l$, {{
               Pattern[$CellContext`a, 
                Blank[]], 
               Pattern[$CellContext`b, 
                Blank[]]}, {{$CellContext`t -> Condition[
                  Pattern[$CellContext`c, 
                   Blank[]], 
                  $CellContext`test[$CellContext`c]], $CellContext`u -> 
                Blank[]}}} -> Hold[
              
              ReplaceAll[{$CellContext`a, $CellContext`b}, {$CellContext`t -> \
$CellContext`c}]]]]; Show[
          Graphics[
           Cases[{
             ...
             Line[
              If[
              Abs[$CellContext`\[Alpha]$$] > 1.57, {{0, -2}, {0, 
               2}}, {{-3, $CellContext`h$$ - 3 
                 Tan[$CellContext`\[Alpha]$$]}, {
                3, $CellContext`h$$ + 3 Tan[$CellContext`\[Alpha]$$]}}]], 
             RGBColor[0.49, 0, 0], 
             Line[$CellContext`pt$$], 
             RGBColor[0.25, 0.43, 0.82], 
             PointSize[0.02], 
             If[Length[$CellContext`soluce1$] > 0, 
              Point[
               ReplaceAll[
                $CellContext`m[$CellContext`pt$$, $CellContext`n$, \
$CellContext`t], $CellContext`soluce1$]]], 
             RGBColor[0.49, 0, 0], 
             If[Length[$CellContext`soluce2$] > 0, 
              Point[$CellContext`soluce2$]]}, 
            Except[Null]]], 
          ParametricPlot[
           $CellContext`m[$CellContext`pt$$, $CellContext`n$, \
$CellContext`t], {$CellContext`t, 0, 1}, PlotStyle -> Thick], 
          ...
          ImageSize -> {500, 300}]], 
      "Specifications" :> {{{$CellContext`h$$, 0}, -2, 2, Appearance -> 
         "Labeled"}, {{$CellContext`\[Alpha]$$, 0.5}, Rational[-1, 2] Pi, 
...
$CellContext`t^$CellContext`i, $CellContext`test[
          Pattern[$CellContext`x, 
           Blank[]]] := 
        And[Im[$CellContext`x] == 0, $CellContext`x >= 0, $CellContext`x <= 
          1], Attributes[PlotRange] = {ReadProtected}}; 
...
Cell[TextData[{
 "This Demonstration illustrates the variation diminishing property for \
planar polynomial B\[EAcute]zier curves: the number of intersection points of \
any straight line with a B\[EAcute]zier curve (blue points) is at most the \
number of intersection points of the same straight line with the control \
polygon of the curve (red points). The parameter ",
 Cell[BoxData[
  FormBox["\[Alpha]", TraditionalForm]], "InlineMath"],
 " controls the angle and the parameter ",
 Cell[BoxData[
  FormBox["h", TraditionalForm]], "InlineMath"],
 " controls the height of the straight line. "
}], "ManipulateCaption"],
...
Cell["\<\
The variation diminishing property also applies to rational B\[EAcute]zier \
curves.\
\>", "DetailNotes",
 CellID->74418026],
...
VariationDiminishingPropertyForBezierCurves&version=0007"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
VariationDiminishingPropertyForBezierCurves/\
VariationDiminishingPropertyForBezierCurves-source.nb"]], \
...
Cell[TextData[{
 "\"",
 ButtonBox["Variation Diminishing Property for B\[EAcute]zier Curves",
  BaseStyle->"SiteLink",
  ButtonData->{
    URL["http://demonstrations.wolfram.com/\
VariationDiminishingPropertyForBezierCurves/"], None},
  ButtonNote->
   "http://demonstrations.wolfram.com/\
VariationDiminishingPropertyForBezierCurves/"],
 "\"",
...
WindowElements->{
 "StatusArea", "MemoryMonitor", "MagnificationPopUp", "VerticalScrollBar", 
  "MenuBar"},
WindowTitle->"Variation Diminishing Property for B\[EAcute]zier Curves",
DockedCells->{},
...
CellTagsIndex->{
 "ControlSuggestions"->{
  Cell[43067, 772, 258, 7, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"],
  Cell[43328, 781, 3600, 80, 70, "ManipulateCaption",
   CellTags->"ControlSuggestions"]},
 "Copyright"->{
  Cell[54034, 1033, 818, 23, 70, "Text",
   CellTags->"Copyright"]}
 }
*)
(*CellTagsIndex
CellTagsIndex->{
 {"ControlSuggestions", 80742, 1602},
 {"Copyright", 80937, 1607}
 }
*)
(*NotebookFileOutline
Notebook[{
Cell[615, 21, 34328, 567, 70, "DemonstrationHeader"],
Cell[34946, 590, 85, 2, 70, "DemoTitle"],
Cell[35034, 594, 7404, 162, 70, "Output",
 CellID->251721086],
Cell[42441, 758, 623, 12, 70, "ManipulateCaption"],
Cell[43067, 772, 258, 7, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[43328, 781, 3600, 80, 70, "ManipulateCaption",
 CellTags->"ControlSuggestions"],
Cell[46931, 863, 33, 0, 70, "DetailsSection"],
Cell[46967, 865, 134, 4, 70, "DetailNotes",
 CellID->74418026],
Cell[47104, 871, 44, 0, 70, "RelatedLinksSection"],
Cell[47151, 873, 634, 21, 70, "RelatedLinks",
 CellID->410279509],
Cell[47788, 896, 4872, 91, 70, "DemoSourceNotebookSection",
 CellGroupingRules->{"SectionGrouping", 25}],
Cell[52663, 989, 45, 0, 70, "CitationSection"],
Cell[52711, 991, 952, 27, 70, "Citations"],
Cell[53666, 1020, 365, 11, 70, "Author"],
Cell[54034, 1033, 818, 23, 70, "Text",
 CellTags->"Copyright"]
}
]
...
(* NotebookSignature tTET9Z4Nri1Qxum5u@Dco7ro *)
